package com.pengniao.cdzcharginginterface.exception.handler;
...
//                    if(e.getCause().getMessage().contains("`"+sqlTable.getTableName()+"`, CONSTRAINT")){
//                        return new Result(ResultCode.SYSTEM_SQL_FOREIGNKEY, sqlTable.message()+"，无法删除");
//                    }
////                System.out.println(sqlTable.getTableName()+":"+sqlTable.message());
//                }
//                return new Result(ResultCode.SYSTEM_SQL_FOREIGNKEY);
//            }
//        }
